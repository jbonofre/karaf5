...
@Log
public class OsgiModuleManager implements ModuleManagerService {
    ...
    public void init(Map<String, Object> properties) throws Exception {
        log.info("Starting OSGi module manager");
    ...
    public String add(String url, Map<String, Object> properties) throws Exception {
        log.info("Adding OSGi module " + url);
        Bundle bundle;
        try {
    ...
    public void remove(String id) throws Exception {
        log.info("Removing OSGi module " + id);
